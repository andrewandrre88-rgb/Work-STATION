// Gentle Web Audio API synthesizer chimes for focus sessions
export function playFocusCompleteSound() {
  try {
    ...
    // Second chime chord (C#6 - 1108.73 Hz)
    ...
    // Third chime (E6 - 1318.51 Hz)
    const osc3 = ctx.createOscillator();
    const gain3 = ctx.createGain();
    osc3.type = 'sine';
    osc3.frequency.setValueAtTime(1318.51, now + 0.4);
    gain3.gain.setValueAtTime(0.2, now + 0.4);
